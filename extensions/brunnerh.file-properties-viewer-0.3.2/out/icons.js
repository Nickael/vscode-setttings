 ...
 */
const svg = (relativePath) => __awaiter(this, void 0, void 0, function* () {
    ...
    const buffer = yield util_1.promisify(fs_1.readFile)(loadPath);
...
__decorate([
    lazy_1.lazy
], Icons.prototype, "copy", null);
exports.icons = new Icons();
