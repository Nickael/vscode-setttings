    ...
    let disposable3 = vscode.commands.registerCommand("regionfolder.wrapWithRegion", () => {
        ...
        if (vscode.window.activeTextEditor) {
            ...
            if (typeof currentLanguageConfig === "undefined" ||
                ...
                vscode.window.showInformationMessage("Maptz Region Folding. No region folding available for language '" +
                    languageId +
